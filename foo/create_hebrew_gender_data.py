...
if __name__ == "__main__":
    ...
    # Uncomment the following line to create the csv file
    ...
    # >>> step 2: convert csv word_gender_csv to samples.jsonl. Make sure the `word_gender_data` is created, without UNKNOWN values
    # Uncomment the following line to create the samples.jsonl file

    # word_gender_csv = pd.read_csv("word_gender_data.csv")
    # print_data_as_samples_jsonl(word_gender_csv)

    # >>> step 3: create csv word_gender_csv of words pairs with labels Y and N for same/not same gender
